...
```
My predictions from the minimum wage data showed me that a full time minimum wage employee will receive $2,400 a month. I used the neighborhood predictions to see what areas this wage would be able to afford according to a common idea which recommends the cost of a place to live should be 30% of the income. Unfortunately, there are no areas in 2020 that will be 30% of $2,400 a month earned by the minimum wage. I decided that a minimum wage earner might be willing to deal with less disposable income in order to afford their living situation. If they spent 60% of their earnings that would be $1,440. Where could they afford to live if they spent 60% of earnings on a one bedroom apartment? 

I wanted to compare what neighborhoods the minimum wage could afford with what the average wage could afford in Los Angeles in 2020. According to my predictions, the average wage would give a person $4,901.60 a month. If this person uses 60% of their income for housing that would mean they spend $2.940.96 a month.
...
ggplot(neighb_graph_df, aes(x = x, y = y)) +
   ...
   scale_color_gradientn(colours = c("red","purple","blue"), 
                         ...
                         guide = "none") +
   annotate(geom = "text", label = "Affordable on minimum wage", 
            x = 10.5, y = 1500, hjust = 0, 
            colour = "red") +
   annotate(geom = "text", label = "Affordable on average wage", 
            x = 45.5, y = 3000, hjust = 0, 
            colour = "purple") +
   annotate(geom = "text", label = "Affordable to higher income earners", 
            x = 62.5, y = 1200, hjust = 0, 
            colour = "blue") +
   coord_flip() +
   theme_bw() +
